...
#mas o titulo do campo resultante será tipo #tipo_cliente por que foi citado primeiro na pesquisa
#o mesmo no cpf, o vendedor nao tem cpf cadastrado, somente sua matricula, mas como é um campo de mesmo tipo
# que cpf, então aparece a matricula do vendedor, mesmo que o titulo seja 'cpf'
